...
function About() {
  ...
  return (
    <div className='about'>
      ...
      <p>To use all features in this app, login with email: <strong>test@test.com</strong> password: <strong>testTest1!</strong>
        <br/>or create your own account <a href="/signup">here</a>
      </p>
    ...
    <Link className='__homeLink' to='/'>Back to Recipes</Link>
    </div>
  )
}
